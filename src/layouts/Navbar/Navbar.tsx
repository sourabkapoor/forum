      ...
      <div styleName="header__content">
        <div styleName="header__left">
          <Link to="/" styleName="header__links">
            <ChatBubbleIcon styleName="header__logo" />
            Forum
          </Link>
          {/* Dropdown */}
          {isLoggedIn && (
            <div styleName="header__dropdown-container">
              <div styleName="header__dropdown" onClick={() => toggleDrawer && toggleDrawer()}>
              ...
              {/* <div className="header__dropdown-menu">
                {isSubscriptionsDropdownOpen && (
                    <NavigationDrawer
                    dropdown={isSubscriptionsDropdownOpen}
        ...
        <div styleName="header__container">
          ...
          <form onSubmit={submitSearch} styleName="header__search-form">
            <input
              ...
              value={searchInput}
              pattern="(?:^| )(/?r/[a-z]+)"
              title={`${searchInput} is not valid. Please enter a 'r/', followed by a forum name in the format 'r/dogs'`}
            />
          </form>
        </div>
